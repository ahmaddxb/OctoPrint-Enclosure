...
# plugin module
plugin_name = "OctoPrint-Enclosure-V2-Beta"
...
plugin_author = "Ahmad Haghshenas"

# The plugin's author's mail address.
plugin_author_email = "ahmaddxb@hotmail.com"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/ahmaddxb/OctoPrint-Enclosure"

# The plugin's license. Can be overwritten within OctoPrint's internal data via __plugin_license__ in the plugin module
plugin_license = "AGPLv3"

# Any additional requirements besides OctoPrint should be listed here
plugin_requires = ["RPi.GPIO>=0.6.5", "gpiod>=2.1.0", "requests>=2.7", "smbus2>=0.3.0", "gpiozero==1.6.2", "RPi.bme280", "bme680"]
